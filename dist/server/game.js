...
import "../shared/models/quiz.model.js";
export const game = {
...
export function findBySocket(socket_id) {
    return game.players.find((player) => player.socketId === socket_id);
}
function hostExists() {
    return game.host;
}
export function isHost(socket_id) {
...
export function isGamePinValid(pin) {
...
export function playerAnswersQues(socketId, ans) {
